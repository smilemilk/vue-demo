<template>
    <div class="login" @keydown.enter="handleSubmit">
        ...
        <div class="footer">
            ...
            <div>
                <a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=33011002011357" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;"><img src="http://test.weimaipay.com:8070/unioncheck/portal/img/beian.png">浙公网安备  33011002011357号</a>
            </div>
        </div>
    </div>
</template>
